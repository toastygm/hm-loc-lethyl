...
template.url = "https://github.com/toastygm/hm-loc-lethyl";
template.bugs = "https://github.com/toastygm/hm-loc-lethyl/issues";
template.manifest =
    "https://github.com/toastygm/hm-loc-lethyl/releases/latest/download/module.json";
template.download = `https://github.com/toastygm/hm-loc-lethyl/releases/download/v${pkg.version}/module.zip`;
